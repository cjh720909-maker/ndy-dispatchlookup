      ...
      <main className="p-2 max-w-md mx-auto pb-20 space-y-1.5">
        ...
        {isLoading && dispatchList.length === 0 ? (
          ...
          dispatchList.map((item) => (
            <div key={item.groupKey} onClick={() => setSelectedDispatch(item)} className="bg-white rounded-xl p-3 border border-slate-200 shadow-sm cursor-pointer active:scale-[0.98] transition-all hover:border-blue-300">
